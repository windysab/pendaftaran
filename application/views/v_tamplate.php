									...
									<form action="<?php echo base_url() ?>index.php/Data_Tamplate" method="POST">
										<div class="row d-flex align-items-center">
											<div class="form-group mr-3">
												...
												<div id="error-message" style="display: none; color: red;">Isi seperti contoh ini 118/Pdt.G/2023/PA.Amt</div>
												<div id="success-message" style="display: none; color: green;">Oke Silahkan Klik Tombol Tampil</div>
											</div>
											<div class="mr-3">
												<input class="btn btn-primary" type="submit" name="btn" value="Tampilkan" />
											</div>
											<div>
												<a href="<?php echo site_url('Data_Tamplate/export_excel/' . str_replace('/', '-', $nomor_perkara)); ?>" class="btn btn-success">Export to Excel</a>
											</div>
										</div>
										<script>
											document.getElementById('nomor_perkara').addEventListener('input', function(e) {
												var regex = /^\d+\/Pdt\.(G|P)(\.|\s)?\/\d+\/PA\.Amt$/i;
												...
												<table class="table table-bordered table-striped">
													...
													<tbody>
														...
														<tr>
															...
															<td>
																...
																if (isset($lines[0])) {
																	...
																	$result = str_replace("Hakim Tunggal: ", "", $result); // tambahkan baris ini
																	echo $result;
																}
																?>
															</td>
														...
														<tr>
															...
															<td>
																<?php echo ($item->tanggal_penetapan_sidang_ikrar != null && $item->tanggal_penetapan_sidang_ikrar != '0000-00-00') ? date('d-m-Y', strtotime($item->tanggal_penetapan_sidang_ikrar)) : ''; ?>
															</td>
															<td></td>
														</tr>
														<tr>
