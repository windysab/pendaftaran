								...
								<div class="card-header">
									...
									Jenis Perkara :	
										<select name="jenis_perkara" required="">
											<option value="Cerai Gugat" <?php echo (isset($_POST['jenis_perkara']) && $_POST['jenis_perkara'] === 'Cerai Gugat') ? 'selected' : ''; ?>>Cerai Gugat</option>
											<option value="Cerai Talak" <?php echo (isset($_POST['jenis_perkara']) && $_POST['jenis_perkara'] === 'Cerai Talak') ? 'selected' : ''; ?>>Cerai Talak</option>
											<option value="Harta Bersama" <?php echo (isset($_POST['jenis_perkara']) && $_POST['jenis_perkara'] === 'Harta Bersama') ? 'selected' : ''; ?>>Harta Bersama</option>
										</select>
										Laporan Bulan :
